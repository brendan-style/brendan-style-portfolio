...
Now that we have the position-agnostic swAV, or Standardized Weighted Approximate Value, we can create a set of dummy variables that can categorize a player's career. Now, it is worth noting that, as the graph below indicates, there is a serious skew towards numbers between 0 and -1.
![](norm_wav_totals.png)
